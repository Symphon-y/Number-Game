...
// compare user guess to computer generated number 
function compareGuesses(userGuess, computerGuess, secretTargetNumber){
    let userDifference = (Math.abs(secretTargetNumber - userGuess));
    let computerDifference = (Math.abs(secretTargetNumber - computerGuess));
    if (computerDifference < userDifference){
        return false;
    }
    else if (userDifference <= computerDifference || userDifference === secretTargetNumber){
        return true;
    };
